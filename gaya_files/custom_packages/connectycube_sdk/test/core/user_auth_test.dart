...
Future<void> main() async {
  ...
  group("Tests AUTH", () {
    ...
    test("testCreateSessionWithGuest", () async {
      CubeUser newUser = CubeUser()
        ..isGuest = true
        ..fullName = 'Guest User';
      ...
      try {
        CubeSession cubeSession = await createSession(newUser);
        assert(cubeSession.id != null);
        assert(cubeSession.user != null);
        userId = cubeSession.userId;
      } finally {
