  ...
  group("Tests CREATE custom objects", () {
    test("testCreate", () async {
      await createTestCustomObject().then((object) async {
        ...
        assert(createdObject.locationField!
            .skipWhile((value) => testObject.locationField!.contains(value))
            .isEmpty);
        assert(createdObject.arrayBooleans!
            .skipWhile((value) => testObject.arrayBooleans!.contains(value))
            .isEmpty);
        assert(createdObject.arrayFloats!
            .skipWhile((value) => testObject.arrayFloats!.contains(value))
            .isEmpty);
        assert(createdObject.arrayIntegers!
            .skipWhile((value) => testObject.arrayIntegers!.contains(value))
            .isEmpty);
        assert(createdObject.arrayStrings!
            .skipWhile((value) => testObject.arrayStrings!.contains(value))
            .isEmpty);
    ...
    test("testCreateWithPermissions", () async {
      ...
      await createCustomObject(cubeCustomObject).then((object) async {
        ...
        CubeCustomObjectPermission updatePermissionCreated =
            permissionsCreated.updatePermission!;

        assert(updatePermissionCreated.ids!
