import 'package:connectycube_sdk/src/chat/query/dialog_history.dart';
...
Future<CubeDialog> addRemoveAdmins(String dialogId, {Set<int>? toAddIds, Set<int>? toRemoveIds}) {
  return AddRemoveAdminsQuery(dialogId, addedIds: toAddIds, removedIds: toRemoveIds).perform();
}
...
///
Future<GlobalSearchResult> searchText(String searchText, [Map<String, dynamic>? params]) {
...
///
Future<PagedResult<CubeMessage>?> getMessages(String dialogId, [Map<String, dynamic>? params]) {
...
///
Future<void> updateMessage(String messageId, String dialogId, [Map<String, dynamic>? params]) {
  return UpdateMessageQuery(messageId, dialogId, params).perform();
}

/// [params] - additional parameters for request. Use class-helper [UpdateMessageParameters] to simple config request
///
Future<void> updateMessages(String dialogId, Map<String, dynamic> params, [Set<String>? messagesIds]) {
  String msgIdsString = "";
...
Future<void> updateMessageReactions(String messageId, {String? addReaction, String? removeReaction}) {
...
Future<DeleteItemsResult> deleteMessages(List<String> messagesIds, [bool? force]) {
  return DeleteMessagesQuery(messagesIds, force).perform();
}

Future<bool> deleteAllMessagesByDialogId(String dialogId) async {
  return GetDialogHistory(dialogId: dialogId).perform();
}

Future<bool> unSubscribeFromPublicDialog(String dialogId) async {
  return GetDialogHistory(dialogId: dialogId).perform();
}
