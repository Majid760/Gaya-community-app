    ...
    for (String property in json.keys) {
      switch (property) {
        ...
        case 'views_count':
          ...
          break;
        case 'read_ids':
          readIds = json[property] != null ? List.of(json[property]).map((id) => id as int).toList() : null;
          break;
        case 'delivered_ids':
          deliveredIds = json[property] != null ? List.of(json[property]).map((id) => id as int).toList() : null;
          break;
        case 'attachments':
          attachments = json[property] != null ? List.of(json[property]).map((element) => CubeAttachment.fromJson(element)).toList() : null;
          break;
        case 'reactions':
          var reactionsRaw = json[property];
          reactions = reactionsRaw == null ? null : CubeMessageReactions.fromJson(json[property]);
          break;
        case 'read':
          isRead = json[property] == 1;
          break;
        case 'created_at':
          createdAt = json[property] != null ? DateTime.parse(json[property]) : null;
          break;
        case 'updated_at':
          updatedAt = json[property] != null ? DateTime.parse(json[property]) : null;
          break;
        default:
          properties[property] = json[property] != null ? json[property].toString() : "";
      }
    }
  }
