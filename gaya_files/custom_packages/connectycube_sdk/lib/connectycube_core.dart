...
/// Pagination
///
Future<PagedResult<CubeUser>?> getAllPaginatedUsers(Map<String, dynamic>? params) {
  Map<String, dynamic> defaultParams = {"page": 1, "per_page": 15};

  return GetUsersQuery.byFilter(null, null, params ?? defaultParams).perform();
}

Future<PagedResult<CubeUser>?> getPaginatedUsersByFullName(String fullName, Map<String, dynamic>? params) {
  Map<String, dynamic> defaultParams = {"page": 1, "per_page": 15};
  return GetUsersQuery.byIdentifier(FILTER_FULL_NAME, fullName, params ?? defaultParams).perform();
}