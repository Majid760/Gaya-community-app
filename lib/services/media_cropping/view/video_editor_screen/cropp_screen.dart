            ...
            Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
              Expanded(
                ...
                child: IconButton(
                  ...
                  icon:   Center(
                    child: Text(GayaStrings.cancel_txt.tr, style: const TextStyle(fontWeight: FontWeight.bold)),
                  ),
                ),
              ),
              Expanded(
              ...
              Expanded(
                ...
                child: IconButton(
                  onPressed: () {
                    ...
                    // WAY 1:
                    controller.updateCrop(controller.cacheMinCrop, controller.cacheMaxCrop);
                    // WAY 2:
  ...
  Widget _buildCropButton(BuildContext context, Fraction? f) {
    ...
    return Flexible(
      child: TextButton(
        ...
        child: Text(f == null ? GayaStrings.free.tr : '${f.numerator}:${f.denominator}'),
      ),
    );
  }
}
