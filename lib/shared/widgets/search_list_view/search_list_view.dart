...
import 'package:gaya/shared/widgets/search_list_view/widget/list_item.dart';
import 'package:gaya/shared/widgets/search_list_view/widget/searchable_text_field.dart';
...
class SearchableList<T> extends StatefulWidget {
  ...
  SearchableList({
    ...
    assert(
      (asyncListCallback != null && asyncListFilter != null) || (initialList != null && filter != null),
    );
