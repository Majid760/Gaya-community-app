...
class HotCommunities extends StatelessWidget {
  const HotCommunities({Key? key}) : super(key: key);
        ...
        builder: (controller) {
          ...
          return Column(
            ...
            children: [
              ...
              CommunityRow(
                onTap: () => Get.to(
                  SeeAllByQueryCommunities(
                    query: controller.getHotCommunitiesQuery,
                    title: GayaStrings.hot_communities_emoji.tr,
                  ),
                ),
                style: CustomTypography.bodyStyle,
                typeOfCommunity: GayaStrings.hot_communities_emoji.tr,
              ),
              SizedBox(
                height: 112.h,
