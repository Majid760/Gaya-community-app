...
class NewCommunities extends StatelessWidget {
  const NewCommunities({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {

    return GetBuilder<NewCommunitiesController>(
        autoRemove: false,
        init: NewCommunitiesController(),
        builder: (controller) {
            ...
            children: [
              ...
              CommunityRow(
                onTap: () => Get.to(SeeAllByQueryCommunities(
                  query: controller.getNewCommunities,
                  title: GayaStrings.new_communities_emoji.tr,
                )),
                style: CustomTypography.bodyStyle,
                typeOfCommunity: GayaStrings.new_communities_emoji.tr,
              ),
              SizedBox(
                height: 112.h,
